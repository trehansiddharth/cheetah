...
class pointcloud_t(object):
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>%df' % self.n, *self.points[:self.n]))
    ...
    def _decode_one(buf):
        ...
        self.points = struct.unpack('>%df' % self.n, buf.read(self.n * 4))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x4781d63fa10b89d5) & 0xffffffffffffffff
